...
fit<-randomForest(shot_made_flag ~ action_type_2 + secondsRemainPeriod
                  + shot_distance + combined_shot_type, data=trainData, importance = TRUE, ntree = 2000)
...
write.csv(submit, file = "Model 23 - RandomForest.csv", row.names = FALSE)
