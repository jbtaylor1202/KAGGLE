...
fit<-randomForest(shot_made_flag ~ combined_shot_type + shot_distance + shot_zone_basic, data=trainData, importance = TRUE, ntree = 2000)
...
write.csv(submit, file = "randomForest2.csv", row.names = FALSE)
