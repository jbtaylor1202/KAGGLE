...
fit<-randomForest(shot_made_flag ~ ., data=trainData, importance = TRUE, ntree = 2000)
...
write.csv(submit, file = "Model 22 - RandomForest (new time and division features).csv", row.names = FALSE)
