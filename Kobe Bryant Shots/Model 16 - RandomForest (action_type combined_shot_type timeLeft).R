...
fit<-randomForest(shot_made_flag ~ action_type + combined_shot_type + timeLeft,
...
write.csv(submit, file = "Model 16 - RandomForest (action_type combined_shot_type timeLeft).csv", row.names = FALSE)
